namespace LAB.DataScanner.CsvToJsonParser
{
    ...
    public class DataPersisterManagedService : StatelessService
    {
        public DataPersisterManagedService(StatelessServiceContext context)
          : base(context)
        {
            ...
            return Task.Run(() =>
            {
                ...
                loggerService.RunWithExceptionLogging(() =>
                {
                    ...
                    var serviceProvider = new ServiceCollection()
                        ...
                        .AddSingleton<ISimpleDataPersisterEngine, SimpleDataPersisterEngine>()
                        .BuildServiceProvider();

                    var engine = serviceProvider.GetService<ISimpleDataPersisterEngine>();
                    engine.Start();
